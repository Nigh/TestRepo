...
#define		NECKRANGEND			0x15180
#define		NECKSTARTBLOCK		0
#define		NECKENDBLOCK		21

#define		ADDR_SAVE_START		0x17000
#define		ADDR_SAVE_BLOCK		23

#define		SN_SAVE_START		0x18000
#define		SN_SAVE_BLOCK		24

#define		STEPRANGSTART		0x20000	//BLOCK32 -- BLOCK37
#define		STEPRANGEND			0x25460
#define		STEPSTARTBLOCK		32
#define		STEPENDBLOCK		37

#define		PROGRAMFLAGADDR		0x27000

#define		PROGRAMERRANGSTART	0x30000	//BLOCK48 -- BLOCKXX (0x30000)
#define		PROGRAMERRANGEND	0xa0000
