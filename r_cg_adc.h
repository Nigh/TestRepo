...
#define _00_AD_ADPC_7ANALOG             (0x00U) /* ANI0 - ANI6 */
...
#define _01_AD_ADPC_0ANALOG             (0x01U) /* ANI0 - ANI6 (all digital) */
...
typedef enum
{
    ...
    ADCHANNEL18 = 18U, ADCHANNEL19, ADTEMPERSENSOR0 = 128U, ADINTERREFVOLT
} ad_channel_t;
typedef enum
{
    ADNORMALINPUT,
