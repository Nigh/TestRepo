...
#define led1Off() TOE0&=0xffff^_0002_TAU_CH1_OUTPUT_ENABLE,TO0 |= _0002_TAU_CH1_OUTPUT_VALUE_1
#define led2Off() TOE0&=0xffff^_0004_TAU_CH2_OUTPUT_ENABLE,TO0 |= _0004_TAU_CH2_OUTPUT_VALUE_1
#define led3Off() TOE0&=0xffff^_0008_TAU_CH3_OUTPUT_ENABLE,TO0 |= _0008_TAU_CH3_OUTPUT_VALUE_1
#define led4Off() TOE0&=0xffff^_0010_TAU_CH4_OUTPUT_ENABLE,TO0 |= _0010_TAU_CH4_OUTPUT_VALUE_1
