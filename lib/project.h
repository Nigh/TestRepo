...
#define NECK_ROLL_POSITIVE_MOVE_DOWNLIMIT (1)
#define NECK_ROLL_NEGATIVE_MOVE_UPLIMIT (-1)
#define NECK_PITCH_POSITIVE_MOVE_DOWNLIMIT (1)
#define NECK_PITCH_NEGATIVE_MOVE_UPLIMIT (-2)
...
#define STR_VERSION "0.9.95S1-T10"	//v1.0.0
